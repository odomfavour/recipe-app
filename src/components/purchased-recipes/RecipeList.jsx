    ...
    return (
        <section className='flex flex-col'>
            {recipes.map(recipe => {
                ...
                return (
                    <section key={id} className='px-[8px] pt-[8px] md:pb-[40px] pb-[24px] border-b border-[#FDE4D3] gap-1 mb-6'>
                        <div
                        
                        className="flex justify-between md:gap-8 gap-[24px]"
                    >
                        ...
                        <div className="md:min-w-5/6 w-2/3">
                            ...
                            <div className="flex justify-between items-center md:mb-6 mb-4">
                                <p className="text-[#7B3D12] font-normal font-raleway md:text-base text-[10px]">
                                    Purchased Yesterday
                                </p>
                                <p className="text-[#7B3D12] font-normal font-raleway md:text-base text-[10px]">
                                    $40.00
